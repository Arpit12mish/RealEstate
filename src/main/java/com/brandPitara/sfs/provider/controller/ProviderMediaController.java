...
public class ProviderMediaController {
    ...
    @PreAuthorize("hasAnyRole('WORKER','BRAND')")
    public ProviderMediaResponse upsertProfilePhoto(@RequestBody UploadMediaRequest req) {
    ...
    @PostMapping("/gallery")
    @PreAuthorize("hasAnyRole('WORKER','BRAND')")
    public ProviderMediaResponse addGallery(@RequestBody UploadMediaRequest req) {
