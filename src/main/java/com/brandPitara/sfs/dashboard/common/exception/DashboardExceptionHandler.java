...
public class DashboardExceptionHandler {
    ...
    public ResponseEntity<DashboardApiErrorResponse> handleBadRequest(
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(
                build(
                        HttpStatus.BAD_REQUEST,
                        "DASHBOARD_INVALID_WORKFLOW",
                        cleanMessage(ex.getMessage(), "Invalid dashboard request."),
                        request
                )
        );
    }
    ...
    public ResponseEntity<DashboardApiErrorResponse> handleNotFound(
        ...
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(
                build(
                        ...
                        "DASHBOARD_RESOURCE_NOT_FOUND",
                        cleanMessage(ex.getMessage(), "Requested dashboard resource was not found."),
                        request
                )
        );
    }
    ...
    public ResponseEntity<DashboardApiErrorResponse> handleBadCredentials(
        ...
        return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(
                build(
                        ...
                        cleanMessage(ex.getMessage(), "Dashboard authentication failed."),
                        request
                )
        );
    }
    ...
    public ResponseEntity<DashboardApiErrorResponse> handleMethodNotSupported(
        ...
        return ResponseEntity.status(HttpStatus.METHOD_NOT_ALLOWED).body(
                build(
                        ...
                        "HTTP method is not allowed for this dashboard endpoint.",
                        request
                )
        );
    }
    ...
    public ResponseEntity<DashboardApiErrorResponse> handleMediaTypeNotSupported(
        ...
        return ResponseEntity.status(HttpStatus.UNSUPPORTED_MEDIA_TYPE).body(
                build(
                        ...
                        "DASHBOARD_UNSUPPORTED_MEDIA_TYPE",
    ...
    public ResponseEntity<DashboardApiErrorResponse> handleDataIntegrity(
        ...
        return ResponseEntity.status(HttpStatus.CONFLICT).body(
                build(
                        HttpStatus.CONFLICT,
                        "DASHBOARD_DATA_CONFLICT",
                        "Data conflict occurred. Duplicate or invalid relational data may already exist.",
                        request
                )
        );
    }
    ...
    public ResponseEntity<DashboardApiErrorResponse> handleUnexpected(
        ...
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(
                build(
                        ...
                        "Something went wrong while processing the dashboard request.",
                        request
                )
        );
    }
