...
GOOGLE_PLACES_CONNECT_TIMEOUT_MS=3000
GOOGLE_PLACES_READ_TIMEOUT_MS=5000
GOOGLE_PLACES_REQUEST_TIMEOUT_MS=8000
# Legacy fallback only; the three explicit values above take precedence.
